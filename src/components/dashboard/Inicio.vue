        ...
        <div id="tour-11" class="content-2 m-3 p-3 rounded-4">
          ...
          <div class="post-content p-4">
            ...
            <ul>
              ...
              <p class="text-post">🛍️ <strong>Recomendações</strong>: Mostre produtos relacionados às suas compras anteriores.</p>
              <p class="text-post">🎯 <strong>Ofertas Personalizadas</strong>: Crie promoções específicas para cada perfil de cliente.</p>
            </ul>
